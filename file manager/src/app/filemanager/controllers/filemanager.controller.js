(function(angular, $) {
    ...
    .controller('FileManagerController', [
        '$http','$scope', '$rootScope', '$window', '$translate', 'fileManagerConfig', 'item', 'fileNavigator', 'apiMiddleware', 'PDF_VIEWER_URL',
        function($http,$scope, $rootScope, $window, $translate, fileManagerConfig, Item, FileNavigator, ApiMiddleware, PDF_VIEWER_URL) {
